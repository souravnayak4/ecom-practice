		...
		<div class="page-wrapper">
			<div class="page-content">
					...
					<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
						...
						<div class="col">
							...
							<div class="card-body">
								<div class="d-flex align-items-center">
									...
									<div class="ms-auto">
                                        <i class="fa-solid fa-box-open text-white fa-3x"></i></i>
									</div>
								</div>
								<div class="progress my-2 bg-white-transparent" style="height:4px;">
									<div class="progress-bar bg-white" role="progressbar" style="width: 55%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
						...
						<div class="col">
							<div class="card radius-10 " style="background-color:Purple;">
							<div class="card-body">
								<div class="d-flex align-items-center">
							...
							<div class="card radius-10 bg-gradient-moonlit">
							 <div class="card-body">
								<div class="d-flex align-items-center">
									...
									<div class="ms-auto">
                                        <i class="fa-solid fa-dollar text-white fa-3x"></i></i>
									</div>
                        ...
                        <div class="col">
							<div class="card radius-10 " style="background-color:#A70D2A;">
							<div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">{{$total_processing}}</h5>
									<div class="ms-auto">
                                        <i class='bx bx-up-arrow-alt text-white fa-3x'></i>
									</div>
								</div>
								<div class="progress my-2 bg-white-transparent" style="height:4px;">
									<div class="progress-bar bg-white" role="progressbar" style="width: 55%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        ...
                        <div class="col">
							<div class="card radius-10 "style="background-color:#842DCE;">
							<div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">{{$total_delivered}}</h5>
									<div class="ms-auto">
                                        <i class="bx bx-up-arrow-alt text-white fa-3x"></i></i>
									</div>
								</div>
								<div class="progress my-2 bg-white-transparent" style="height:4px;">
									<div class="progress-bar bg-white" role="progressbar" style="width: 55%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
