                                ...
                                <div class="row row-cols-1">
                                    <div class="col">
                                        <div class="slider__content">
                                            ...
                                            <a class="bg__secondary2 slider__btn primary__btn" href="/shop">Show Collection
            ...
            <div class="row mb--n28">
                <div class="col-lg-4 col-md-order mb-28">
                    <div class="banner__items position__relative">
                        <a class="banner__items--thumbnail " href="shop.html"><img class="banner__items--thumbnail__img" src="{{asset('frontend')}}/img/banner/banner7.png" alt="banner-img">
                ...
                <div class="col-lg-8">
                    <div class="banner__style2--top__sidebar d-flex">
                        <div class="banner__items position__relative mr-30 mb-28">
                            <a class="banner__items--thumbnail" href="shop.html"><img class="banner__items--thumbnail__img banner__img--max__height" src="{{asset('frontend')}}/img/banner/banner8.png" alt="banner-img">
                                <div class="banner__items--content style2">
                                    <h3 class="banner__items--content__title style2">NEW <br>
                                        ACCESSORIES</h3>
                                    <span class="banner__items--content__link style2">SHOP NOW</span>
                        ...
                        <div class="banner__items position__relative mb-28">
                            <a class="banner__items--thumbnail" href="shop.html"><img class="banner__items--thumbnail__img" src="{{asset('frontend')}}/img/banner/banner9.png" alt="banner-img"> 
                                <div class="banner__items--content style2">
                    ...
                    <div class="row row-cols-sm-2 row-cols-1">
                        <div class="col mb-28">
                            <div class="banner__items position__relative">
                                <a class="banner__items--thumbnail" href="shop.html"><img class="banner__items--thumbnail__img banner__img--max__height" src="{{asset('frontend')}}/img/banner/banner10.png" alt="banner-img"> 
                                    <div class="banner__items--content style2">
                        ...
                        <div class="col mb-28">
                            <div class="banner__items position__relative">
                                <a class="banner__items--thumbnail" href="shop.html"><img class="banner__items--thumbnail__img banner__img--max__height" src="{{asset('frontend')}}/img/banner/banner11.png" alt="banner-img"> 
                            ...
                            <div class="product__items product__items--grid d-flex align-items-center">
                                <div class="product__items--grid__thumbnail position__relative">
                                    <a class="product__items--link" href="product-details.html">
                                        ...
                                        <img class="product__items--img product__secondary--img" src="{{asset('frontend')}}/img/product/small-product5.png" alt="product-img">
                                    </a>
                                </div>
                                <div class="product__items--grid__content">
            ...
            <div class="row row-cols-1">
                <div class="col">
                    <div class="brand__logo--section__inner d-flex justify-content-center align-items-center">
                        ...
                        <div class="brand__logo--items">
                            <img class="brand__logo--items__thumbnail--img display-block" src="{{asset('frontend')}}/img/logo/brand-logo5.png" alt="brand logo img">
                        </div>
                    </div>
                </div>
            </div>
