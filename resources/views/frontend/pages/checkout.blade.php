            ...
            <div class="checkout__page--inner d-flex">
                <div class="main checkout__mian">
                    <header class="main__header checkout__mian--header mb-30">
                        <h1 class="main__logo--title"><a class="logo logo__left mb-20" href="index-2.html"><img src="{{asset('frontend')}}/img/logo/nav-log.png" alt="logo"></a></h1>
                    ...
                    <footer class="main__footer checkout__footer">
                        <p class="copyright__content">Copyright © 2022 <a class="copyright__content--link text__primary" href="index-2.html">Suruchi</a> . All Rights Reserved.Design By Suruchi</p>
                    </footer>
                </div>
